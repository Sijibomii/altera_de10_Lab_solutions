...
\L1|S_g\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \L1|S_g~combout\ = LCELL((!\SW[0]~input_o\) # (!\SW[1]~input_o\))
...
\L1|R\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \L1|R~combout\ = LCELL(!\SW[0]~input_o\)
...
PORT MAP (
	datad => \SW[0]~input_o\,
	combout => \L1|R~combout\);

-- Location: LCCOMB_X51_Y53_N6
\L1|R_g\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \L1|R_g~combout\ = LCELL((!\SW[1]~input_o\) # (!\L1|R~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \L1|R_g~combout\,
	datad => \L1|Qa~combout\,
	combout => \L1|Qb~combout\);

-- Location: LCCOMB_X51_Y53_N24
\L1|Qa\ : fiftyfivenm_lcell_comb
-- Equation(s):
